  ...
  return (
    <div className="bg-white text-black min-h-screen pt-[60px] sm:pt-[65px] md:pt-[70px] lg:pt-[75px]">
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 max-w-4xl mx-auto text-center">
        <h2 className="text-2xl sm:text-3xl font-black uppercase mb-6 sm:mb-8">Our Mission</h2>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 max-w-6xl mx-auto">
        <h2 className="text-2xl sm:text-3xl font-black uppercase mb-8 sm:mb-10 md:mb-12 text-center">Meet the Experts</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
          <div className="p-6 sm:p-8 bg-black text-white border-b-4 border-yellow-500">
            <h3 className="text-xl sm:text-2xl font-bold mb-2">Lead Technician</h3>
            <p className="text-sm sm:text-base text-gray-400">Over 10 years of experience in high-performance two-wheeler diagnostics and repair.</p>
          </div>
          <div className="p-6 sm:p-8 bg-black text-white border-b-4 border-yellow-500">
            <h3 className="text-xl sm:text-2xl font-bold mb-2">Customer Care</h3>
            <p className="text-sm sm:text-base text-gray-400">Dedicated to ensuring seamless service scheduling and transparent communication for every client.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-neutral-100 px-4 sm:px-6 md:px-8 text-center">
        <h2 className="text-2xl sm:text-3xl font-black uppercase mb-8 sm:mb-10">Why Choose Us?</h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 md:gap-10 max-w-5xl mx-auto">
          <div>
            ...
            <h4 className="font-bold text-lg sm:text-xl uppercase">Precision</h4>
          </div>
          <div>
            <div className="text-yellow-500 text-3xl sm:text-4xl mb-3 sm:mb-4">★</div>
            <h4 className="font-bold text-lg sm:text-xl uppercase">Reliability</h4>
          </div>
          <div>
            <div className="text-yellow-500 text-3xl sm:text-4xl mb-3 sm:mb-4">★</div>
            <h4 className="font-bold text-lg sm:text-xl uppercase">Transparency</h4>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-black text-white text-center">
        <h2 className="text-2xl sm:text-3xl font-black uppercase mb-4 sm:mb-6 text-yellow-500">Join Our Community</h2>
        <p className="mb-6 sm:mb-8 text-gray-300 text-sm sm:text-base px-2 sm:px-0">We are proud to serve the Mukkadu community and beyond.</p>
        <a href="/services" className="bg-yellow-500 text-black px-8 sm:px-10 py-2.5 sm:py-3 font-bold uppercase hover:bg-yellow-400 transition-colors inline-block text-sm sm:text-base">
          View Our Services
        </a>
      </section>
    </div>
